...
public static String build_Name;
    ...
    public void beforeSuiteWorks()
    {
        ...
        build_Name = "Build_" + TestDatas.getTodayDateinFormat("dd-MMM-yyyy");
        ...
        if (ITestResult.FAILURE == result.getStatus()) {
            try {
                ...
                if (!platform.equalsIgnoreCase("api")) {
                    ...
                    file = new File("src/test/resources/failed_test_screenshot/" + result.getName() + "_" + TestDatas.random_alpha_numeric_string(5) + ".png");
