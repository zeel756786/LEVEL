...
public class Sleep_Playlist_Page {
    ...
    public void verify_meditation_text_present_on_page() {
        wait.wait_until_element_is_visible("meditation_button");
        verify.element_is_present("meditation_button");
    }
    ...
    public void edit_the_playlist_name() {
        ...
        longPress.addAction(finger.createPointerMove(Duration.ofMillis(0), PointerInput.Origin.viewport(), textField.getLocation().getX(), textField.getLocation().getY()));
        longPress.addAction(finger.createPointerDown(PointerInput.MouseButton.LEFT.asArg()));
        longPress.addAction(new Pause(finger, Duration.ofSeconds(1)));
        longPress.addAction(finger.createPointerUp(PointerInput.MouseButton.LEFT.asArg()));
        androidDriver.perform(Collections.singletonList(longPress));
        textField.clear();
        androidDriver.hideKeyboard();
    ...
    public void verify_remove_from_favorites() {
    ...
    public static void scrollDownAndClickPlaylists(AndroidDriver androidDriver) {
        ...
        try {
            ...
            if (yourPlaylistsElement.isDisplayed()) {
                ...
                androidDriver.findElement(By.xpath(
                        "//android.widget.TextView[@text=\"Your Playlists\"]/following-sibling::android.widget.TextView")).click();
